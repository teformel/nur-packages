...
rec {
  ...
  lingmo-desktop = pkgs.callPackage ./pkgs/lingmo-desktop { qt6 = pkgs.kdePackages; };
  lingmo-daemon = pkgs.callPackage ./pkgs/lingmo-daemon { qt6 = pkgs.kdePackages; };
  ...
  lingmo-screenlocker = pkgs.callPackage ./pkgs/lingmo-screenlocker { qt6 = pkgs.kdePackages; };
