...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    ...
    find . -type f -name "CMakeLists.txt" -exec sed -i 's/Qt6::GuiPrivate/Qt6::Gui/g' {} +
    find . -type f -name "CMakeLists.txt" -exec sed -i 's/Qt${QT_VERSION_MAJOR}::GuiPrivate/Qt${QT_VERSION_MAJOR}::Gui/g' {} +
